...
(function () {
  ...
  var DICT = {
    ...
    'Deep Dive': '深度分析',
    'Is prime finally on sale?': '优质地段终于降价了吗？',
    'Prime is the only segment falling, a real opening for local buyers who plan to hold, but an easing, not a fire sale.': '优质地段（Prime）是唯一出现下跌的细分市场，为计划长期持有的本地买家提供了真正的入市机会，但这属于温和回调，而非抛售离场。',
