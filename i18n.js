...
(function () {
  ...
  'Afford': '估算负担',
  'Schools': '学校',
  // ── recent-deals panel: built in JS around interpolated numbers, so these go
  //    through PSI18N.t / PSI18N.tf rather than the text-node sweep ──
  'from {n} recent caveats': '来自 {n} 宗近期成交记录',
  'latest across Singapore': '全岛最新成交',
  '{n} match': '{n} 宗结果',
  '{n} matches': '{n} 宗结果',
  'No recent sales match that yet. Try a town like Bishan, Tampines or Punggol.':
    '暂时没有符合的近期成交。可以试试 Bishan、Tampines 或 Punggol 这些市镇。',
  // ── 404 page ──
  'Page not found': '页面找不到',
  'We looked, but this page is not here.': '我们找过了，这个页面不在这里。',
  'The link may be old, or the address slightly off. Everything on PropSight is a click or two away, so let us point you back.':
  ...
  'Keep all your property tools one tap away.': '所有房产工具，一点即开。',
  "Add PropSight to your home screen, it opens like an app, works even when you're offline, and there's no app store or sign-up.":
    '把 PropSight 加到主屏幕，打开就像一个应用，没网也能用，不必上应用商店，也不用注册。',
  'One tap to every tool': '一点直达所有工具',
  'Works offline': '离线也能用',
  'No app store': '无需应用商店',
  'Install now →': '立即添加 →',
  'Install now': '立即添加',
  'Open this page in': '用这个浏览器打开本页：',
  'Tap the': '点一下',
  'button': '按钮',
  '(bottom of the screen).': '（在屏幕底部）。',
  'Scroll down and tap': '往下滑，点',
  'Add to Home Screen': '添加到主屏幕',
  'Add to Home screen': '添加到主屏幕',
  'Tap': '点',
  'Add': '添加',
  ', the icon appears on your home screen.': '，图标就会出现在你的主屏幕上。',
  '(top-right).': '（在右上角）。',
  'Install app': '安装应用',
  'Install': '安装',
  ', done.': '，完成。',
  'Or just tap': '或者直接点上面的',
  'above if it appears.': '（如果有出现的话）。',
  'It\'s not a "real" app from the store': '它不是应用商店里那种「真正的」应用',
  ", it's this website, saved to your home screen so it opens full-screen in one tap. Nothing to download, nothing to update.":
    '，它就是这个网站，存到你的主屏幕上，一点就全屏打开。不用下载，也不用更新。',
  'Explore the tools first →': '先看看有哪些工具 →',
  '← Back to PropSight': '← 回到 PropSight',
  '← Back to home': '← 回到首页',
  ...
  'Deep dives': '深度解读',
  'Property news': '房产新闻',
  'The whole market, every month': '每月一次，纵观全局',
  'One sharp question at a time': '每次只讲透一个问题',
  ...
  'Step two': '第二步',
  'Step three': '第三步',
  'What you can afford': '你能负担多少',
  'Your real budget, from the lending rules': '按贷款规则算出的真实预算',
  'What a home is worth': '一套房子值多少',
  'Valued on recent sales nearby': '以周边近期成交估算',
  'What people actually paid': '别人实际付了多少',
  'Every recent sale, searchable': '每一宗近期成交，可搜索',
  'Priced against the resale next door.': '对比隔壁转售房的价格。',
  'launch.lede': '这些新盘还没开始接受预订。每个项目都对比周边组屋与公寓的真实成交价，让你看清楚新盘的溢价有多少。',
  'Coming soon': '即将开盘',
  'Selling now': '正在销售',
  'Real caveats': '真实成交',
  'launch.q1': '尚未开盘的新盘，报价比周边转售高出三分之一到一倍。',
  'launch.s1': '在开盘日之前，先看看每个项目对比周边真实价格的情况。',
  'launch.q2': '选哪个新盘，比什么时候买更重要。',
  'launch.s2': '一半的新盘成交价比周边转售高 32% 到 57%，但整体范围从几乎为零到超过 100%。',
  'See upcoming launches': '查看即将开盘的新盘',
  'See what is selling': '查看正在销售的项目',
  'The market now': '当前楼市',
  'See the market': '查看楼市',
  'Weekly': '每周更新',
  ...
  'deals.lede': '新加坡每一宗近期的组屋与私宅成交。私宅价格来自契约，也就是买家付定金时登记的记录，所以这些是真正谈成的价格，不是挂牌价。可搜索楼盘、街道或市镇，也可以直接往下滑。',
  ...
  'Latest read': '最新解读',
  'The Singapore Property Board': '新加坡房产看板',
  'built on official URA and HDB data': '基于市建局与建屋局官方数据',
  'What homes cost now': '现在的房价',
  'a typical 4-room HDB resale': '一套典型的四房式组屋转售',
  'a typical condo or private home': '一套典型的公寓或私宅',
  'Roughly, per month': '大致每月供款',
  'Show me around': '带我逛一圈',
  'What did flats near me sell for?': '我附近的房子成交价多少？',
  'New launches': '新盘',
  'Look up a project': '查一个楼盘',
  'Guides for my town': '我的市镇指南',
  'What grants can I get?': '我能拿到哪些津贴？',
  'Am I eligible?': '我符合条件吗？',
  'I do not have an answer written for that one. I stick to what the sale records can actually show, so I would rather point you somewhere real than guess. Here is what I can do, or the team can take it from here.': '这个我没有现成的答案。我只讲成交记录能说明的事，与其猜，不如把你带到真实的资料前。下面是我能做的，也可以直接交给团队跟进。',
  'Every recorded HDB and private sale, searchable by project or street. You can see what people actually paid, and the notable ones are flagged: a record price for that project, a sale well above or below its usual, or a million-dollar flat.': '每一宗有记录的组屋和私宅成交，可按楼盘或街道搜索。你能看到别人实际付了多少，特别的成交还会标出来：该楼盘的最高价、明显高于或低于常态的成交，或百万组屋。',
  'The market tracker refreshes every week off the same sale records. It shows what HDB and private prices are doing, which towns moved most over the past quarter, and how much of that is real movement rather than noise.': '市场追踪每周依据同一批成交记录更新，显示组屋和私宅价格的走向、过去一个季度涨跌最大的市镇，以及其中有多少是真实变动而非噪音。',
  'Deep Dives are longer written explainers on how one part of the Singapore market actually works, researched and written out properly rather than summarised.': '深度解读是较长的专题文章，讲清楚新加坡房市某一环节的实际运作，经过查证认真写成，而不是概括带过。',
  'There is a guide for every HDB town: what homes there cost, how prices have moved, what is nearby, and who the area suits.': '每个组屋市镇都有一份指南：当地房价、价格走势、周边配套，以及这个区适合什么样的人。',
  'Every new launch, priced against what resale homes nearby actually sell for, so an asking price means something. The list refreshes weekly.': '每个新盘都对照周边转售房的真实成交价来看，开价才有参照。列表每周更新。',
  'Research covers every Singapore condo and HDB block: price psf, the trend over time, rental yield, tenure, and how it is priced against comparable homes nearby.': '楼盘研究涵盖新加坡每一个公寓和组屋座号：每平方英尺价格、历年走势、租金回报、地契年限，以及与周边同类房源的价格对比。',
  'Everything here is free to use and there is no sign-up. The numbers come from official transaction records, not listings.': '这里的一切都免费使用，也不需要注册。数字来自官方成交记录，而不是挂牌广告。',
  'The numbers come from official records: HDB resale registrations and URA caveats for private sales. Nothing here is based on asking prices, which are what a seller hopes for rather than what a home went for.': '数字来自官方记录：组屋转售登记和市区重建局的私宅成交备案。这里没有任何数字取自挂牌价，挂牌价只是卖方的期望，不是成交价。',
  'Happy to hand you to a real person. Adam can pick this up directly on WhatsApp.': '很乐意帮你转给真人。Adam 可以直接在 WhatsApp 上接手。',
  'PropSight is built on the actual sale records, not listings. Four things people use most:': 'PropSight 建立在真实成交记录之上，而不是挂牌广告。大家最常用的四样：',
  'Sold prices. Every recorded HDB and private sale, searchable, with the notable ones flagged.': '成交价。每一宗有记录的组屋和私宅成交，可搜索，特别的会标出来。',
  'The market tracker. Refreshed weekly: what prices are doing and which towns moved.': '市场追踪。每周更新：价格走向，以及哪些市镇有变动。',
  'New launches, each priced against real resale nearby so the asking price means something.': '新盘，每个都对照周边真实转售价，开价才有参照。',
  'And the tools: what you can afford, what a home is worth, stamp duty, grants. All free, no sign-up.': '还有各项工具：你能负担多少、房子值多少、印花税、津贴。全部免费，无需注册。',
  'Search sold prices': '搜索成交价',
  'See the market tracker': '查看市场追踪',
  'Read the Deep Dives': '阅读深度解读',
  'Browse the town guides': '浏览市镇指南',
  'See the launches': '查看新盘',
  'Open Research': '打开楼盘研究',
  'About PropSight': '关于 PropSight',
  'See the sale records': '查看成交记录',
  'Message the team': '联系团队',
  'See the tracker': '查看追踪',
  'Start with your budget': '先算你的预算',
  'What did flats near you sell for?': '你附近的房子成交价多少？',
  ...
  "I will show what you would actually walk away with after the loan, the CPF refund and costs, plus any Seller's Stamp Duty.": "我会算出扣掉贷款、公积金退还和各项费用之后，你实际能拿到多少，也包括卖方印花税。",
  "I will work out your stamp duty to the dollar: buyer's stamp duty plus any ABSD that applies to you.": "我会把你的印花税算到分毫：买方印花税，加上适用于你的额外买方印花税。",
  "Pick a primary school and I will show the homes within 1km and 2km for P1 registration priority, with the real prices.": "选一所小学，我会列出 1 公里和 2 公里内的房子，用于小一报名的优先顺序，并附上真实价格。",
  "First-timers can get CPF housing grants such as EHG, Family and Proximity. I will estimate what you would likely qualify for.": "首次购房者可以申请公积金购屋津贴，例如 EHG、家庭津贴和临近津贴。我会估算你大概能拿到哪些。",
  "Value my home": "为我的房子估价",
  "What I can afford": "我能负担多少",
  "My town": "我的市镇",
  'Next BTO launch': '下一轮预购组屋',
  'Buying your first home': '购买首套房',
  'The market now, past 3 months': '当前市场 · 近三个月',
  'Suburbs': '郊区',
  'City fringe': '市区边缘',
  'Prime core': '核心中央区',
  'Indicative, not financial advice.': '仅供参考，非投资建议。',
  'Read the full market analysis': '阅读完整市场分析',
  ...
  ', measured straight-line from each condo to an approximate school location, close to, but not identical to, MOE’s official figure (which uses the exact main gate). Always confirm the exact distance with the': '，以每个公寓到学校约略位置的直线距离计算，接近但不完全等同于教育部的官方数字（官方以确切的正门为准）。请务必向以下单位确认准确距离：',

  // ── tool pages: strings that were leaking English into 中文 ──
  'estimate from recent comparable sales': '根据近期可比成交得出的估算',
  "your bank loan and CPF only stretch up to the bank's valuation, if you agree to pay": "银行贷款和公积金最多只能用到银行估价为止，如果你同意支付",
  "HDB flats and new ECs have a stricter cap, the loan alone can't exceed 30% of your income.": "组屋和新执行共管公寓的上限更严，单是贷款就不能超过你收入的 30%。",
  'An HDB loan is stress-tested at 3% (banks use 4%) and needs no minimum cash, so your budget can come out differently.': '组屋贷款以 3% 做压力测试（银行用 4%），也没有最低现金要求，所以你的预算可能会不一样。',
  "(it's added to your CPF)": "（会存入你的公积金）",
  'home. Leave blank for a new or freehold one. On a short lease, the rules cut how much CPF and loan you can use.': '的房子。如果是新房或永久地契，请留空。剩余地契短时，规定会减少你可动用的公积金和贷款。',
  "when buying another subsidised flat. It's based on this first flat.": "在购买另一套有津贴的组屋时需要缴付。金额以这第一套组屋为准。",
  'An estimate of the main grants (EHG, CPF Housing/Family Grant, Proximity, EC), not an official confirmation. Grants are': '这是主要津贴（EHG、公积金购屋／家庭津贴、就近津贴、EC）的估算，并非官方确认。津贴会',
  'credited to your CPF and used to pay for the flat': '存入你的公积金，用来支付组屋',
  '(not cash). EHG also needs': '（不是现金）。EHG 还需要',
  "12 months' continuous work": "连续 12 个月的工作记录",
  '; "first-timer" means no prior housing subsidy. Other rules apply (age, occupier, ownership, citizenship), and second-timers may get the': '；「首次购房者」指此前未领过任何购屋津贴。其他条件同样适用（年龄、住户、房产持有、公民身份），二次购房者在某些情况下可获得',
  'in some cases. Always confirm your exact grants with': '。请务必向以下单位确认你实际可得的津贴：',
  'A quick guide, not official confirmation, Singapore housing rules have many exceptions (schemes, grants, age, family situation). Always confirm your exact case with': '这只是快速指引，并非官方确认。新加坡的房屋条例有许多例外（计划、津贴、年龄、家庭状况）。请务必向以下单位确认你的具体情况：',
  '(for flats/ECs) or a banker, or message us. Rules as of': '（组屋／EC 事宜）或银行人员，也可以直接联系我们。条例更新至',
  '; the newest EC sites (from May 2026) carry a longer 10-year stay.': '；最新的 EC 地段（2026 年 5 月起）需住满更长的 10 年。',
  'Buying with P1 registration in mind? Pick a school and see which condos sit within': '打算为小一报名而买房？选一所学校，看看哪些公寓位于',
  '(next in line), measured straight-line, the same way MOE does.': '（次一级），以直线距离计算，与教育部的做法相同。',
  'HDB resale data in Research': '研究工具里的组屋转售数据',
  'How the 1km / 2km rule works.': '1 公里／2 公里规则是怎么运作的。',
  'When a school has more applicants than places, children are ranked by how close home is: those': '当报名人数多过学额时，孩子会按住家距离排序：',
  'priority, not a guarantee': '优先，不是保证',
  ', popular schools still ballot. And to keep the priority you must': '，热门学校仍会抽签。而且要保住这个优先权，你必须',
  'live at that address for at least 30 months': '在该地址住满至少 30 个月',
  'from the start of the registration exercise.': '，从报名活动开始起算。',
  'official MOE / OneMap School Query': '教育部／OneMap 官方学校查询',
  'before deciding. This list shows': '再做决定。此列表显示的是',
  '(landed homes and HDB flats can also qualify and aren’t listed here). Some smaller or newer projects may be missing. Built on URA caveat data, not affiliated with MOE.': '（有地住宅和组屋同样可能符合条件，但未列在这里）。部分较小或较新的楼盘可能未收录。数据来自市区重建局的成交记录，与教育部无关。',
  'Indicative estimate only, not financial advice. Stamp duty is charged on the': '仅供参考的估算，非财务建议。印花税按',
  "higher of the price or the home's market valuation": "价格与市场估价两者中的较高者",
  '. Final duties are determined by IRAS. Figures shown are the latest official rates.': '计算。最终税额由新加坡税务局（IRAS）决定。所示数字为最新官方税率。',
  ...
  'What Will I Walk Away With?, PropSight · Singapore Property': '卖房后我能拿回多少？· PropSight 新加坡房产',
    ...
    'Deep Dive': '深度分析',
    'A record number of flats can finally be sold this year. Does that make them cheaper?': '今年将有创纪录数量的组屋获准转售。这会让它们更便宜吗？',
    'Newly eligible flats look 20% pricier per square foot, but almost all of that gap is the longer lease, not the flat.': '刚满五年的组屋每平方英尺看起来贵约20%，但这个差距几乎全来自更长的剩余屋契，而非组屋本身。',
