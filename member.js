...
(function () {
  ...
  var CSS = ''
   + '.psj-card{--g:#24402F;--g2:#2E7D5B;--br:#1F6B4F;--ink:#211D16;--ink2:#485a56;--ink3:#586e69;--line:#E4DBCA;'
   ...
   + '.psj-ey{display:inline-block;font-size:10px;font-weight:800;letter-spacing:.15em;text-transform:uppercase;color:#1A1712;'
   + 'background:var(--gtex,none),#24402F;padding:5px 11px;border-radius:30px;margin-bottom:14px}'
   ...
   + '.psj-tick{flex:none;width:20px;height:20px;border-radius:50%;background:#F4EEDE;border:1px solid #E4DBCA;display:flex;align-items:center;justify-content:center;margin-top:1px}'
   ...
   + '.psj-form button,.psj-siform button{width:100%;padding:14px;border:0;border-radius:12px;background:var(--g);color:#EBE2D2;font-size:15px;font-weight:700;font-family:inherit;cursor:pointer;transition:.18s;margin-top:2px}'
   ...
   + '.psj-msg{font-size:13px;font-weight:600;margin-top:11px;min-height:1px}.psj-msg.ok{color:#2E7D5B}.psj-msg.err{color:#c0392b}'
   ...
   + '.psj-acct .psj-go{background:var(--g);color:#EBE2D2}.psj-acct .psj-go:hover{background:#163025}'
   + '.psj-acct .psj-tg{background:#F4EEDE;color:var(--g);border:1px solid #E4DBCA}.psj-acct .psj-tg:hover{background:#dff0e7;border-color:#bfe0cd}'
