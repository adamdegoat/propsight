...
(function () {
  ...
  var ITEMS = [
    ...
    { k:'menu',  t:'Neighbourhoods', href: BASE + '/areaguides/', kids:[
        ...
        ['Compare homes',    BASE + '/research/',          'spark', 'Every condo and HDB, side by side'],
  ...
  if (!window.PSI18N && !document.querySelector('script[src*="i18n.js"]')) {
    var _i18 = document.createElement('script'); _i18.src = BASE + '/i18n.js?v=20260721a'; document.head.appendChild(_i18);
  }
